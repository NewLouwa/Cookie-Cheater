...
CookieCheater.modules.garden = {
    ...
    _getMutationPattern: function(cols, rows, sameSeed) {
        ...
        // Different plant patterns — diagonal/corner placement for max mutation coverage
        // Corners pattern: A and B in opposite corners, all empty tiles are valid mutation spots
        var diff = {
            '2x2': [['A','_'],['_','B']],                                                          // diagonal: 2/2 mutation tiles
            '3x2': [['A','_','_'],['_','_','B']],                                                  // diagonal: 2/4 mutation tiles, cheap
            '3x3': [['A','_','B'],['_','_','_'],['B','_','A']],                                    // corners: 5/5 = 100% efficiency!
            '4x3': [['A','_','B','_'],['_','_','_','_'],['B','_','A','_']],                        // corners: 6/8
            '4x4': [['A','_','_','B'],['_','_','_','_'],['_','_','_','_'],['B','_','_','A']],      // corners: 4/12
            '5x4': [['A','_','B','_','A'],['_','_','_','_','_'],['B','_','A','_','B'],['_','_','_','_','_']], // alternating rows
